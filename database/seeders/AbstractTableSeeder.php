    ...
    public function run(): void
    {
        $abstracts = [
            [
                ...
                'dissertation_topic' => 'Exploring Cultural Idioms in English and Spanish',
                'locale_id' => 1,
                'academic_degree' => 'PhD',
                'specialty_code_and_name' => '10.00.06 – Comparative Literature, General Linguistics, Translation Studies',
                'protection_year' => 2022,
                'file_url' => 'https://example.com/abstracts/alice_smith_abstract.pdf',
                'created_at' => now(),
                'updated_at' => now(),
            ],
            [
                'applicant_name' => 'Bob Johnson',
                'dissertation_topic' => 'Analysis of Ecological Terminology in English, Russian, and Uzbek',
                'locale_id' => 1,
                'academic_degree' => 'DSc',
                'specialty_code_and_name' => '10.00.06 – Comparative Literature, General Linguistics, Translation Studies',
                'protection_year' => 2021,
                'file_url' => 'https://example.com/abstracts/bob_johnson_abstract.pdf',
                'created_at' => now(),
                'updated_at' => now(),
            ],
            [
                'applicant_name' => 'Eva Brown',
                'dissertation_topic' => 'Stylistic Synonym Translation between English and Uzbek Languages',
                'locale_id' => 1,
                'academic_degree' => 'PhD',
                'specialty_code_and_name' => '10.00.06 – Comparative Literature, General Linguistics, Translation Studies',
                'protection_year' => 2020,
                'file_url' => 'https://example.com/abstracts/eva_brown_abstract.pdf',
                'created_at' => now(),
                'updated_at' => now(),
            ],
            [
                'applicant_name' => 'David Clark',
                'dissertation_topic' => 'Cognitive Analysis of Modal Categories in French and Uzbek Novels',
                'locale_id' => 2,
                'academic_degree' => 'PhD',
                'specialty_code_and_name' => '10.00.06 – Comparative Literature, General Linguistics, Translation Studies',
                'protection_year' => 2019,
                'file_url' => 'https://example.com/abstracts/david_clark_abstract.pdf',
                'created_at' => now(),
                'updated_at' => now(),
            ],
            [
                'applicant_name' => 'Sophia Adams',
                'dissertation_topic' => 'Semantics and Stylistics of Proverbial Phrases in English, Russian, and Uzbek',
                'locale_id' => 2,
                'academic_degree' => 'PhD',
                'specialty_code_and_name' => '10.00.06 – Comparative Literature, General Linguistics, Translation Studies',
                'protection_year' => 2018,
                'file_url' => 'https://example.com/abstracts/sophia_adams_abstract.pdf',
                'created_at' => now(),
                'updated_at' => now(),
            ],
        ];
