    ...
    public function run(): void
    {
        ...
        $parentConventions = [
            ...
            [
                ...
                'photo_url' => 'convention_files/photos/image.png',
                'type' => '1',
                'parent_id' => null,
                'created_at' => now(),
                'updated_at' => now(),
        ...
        $childConventions = [
            ...
            [
                'name' => 'SALOHIY DILOROM',
                'description' => 'SALOHIY DILOROM',
                'locale_id' => 1,
                'file_url' => 'convention_files/files/Salohiy Dilorom.pdf',
                'photo_url' => 'convention_files/photos/img_4.png',
                'type' => '1',
                'parent_id' => $parentIds['3-SON JURNAL'],
                'created_at' => now(),
                'updated_at' => now(),
            ],
            [
                'name' => 'TUROBOY JAXONGIR',
                'description' => 'TUROBOY JAXONGIR',
                'locale_id' => 1,
                'file_url' => 'convention_files/files/Turoboy Jaxongir.pdf',
            ...
            [
                'name' => 'ZHANG, YEHONG',
                'description' => 'ZHANG, YEHONG',
                'locale_id' => 1,
                'file_url' => 'convention_files/files/ZHANG, Yehong.pdf',
                'photo_url' => 'convention_files/photos/Titul_page-001.jpg',
                'type' => '1',
                'parent_id' => $parentIds['3-SON JURNAL'],
                'created_at' => now(),
            ...
            [
                ...
                'description' => 'XALLIYEVA GULNOZ',
                'locale_id' => 1,
                'file_url' => 'convention_files/files/Xalliyeva Gulnoz.pdf',
                'photo_url' => 'convention_files/photos/Titul_page-001.jpg',
                'type' => '1',
                'parent_id' => $parentIds['3-SON JURNAL'],
                'created_at' => now(),
            ...
            [
                'name' => 'SONYA STOJMENSKA',
                'description' => 'SONYA STOJMENSKA',
                'locale_id' => 1,
                'file_url' => 'convention_files/files/Sonya Stojmenska.pdf',
                'photo_url' => 'convention_files/photos/Titul_page-001.jpg',
                'type' => '1',
                'parent_id' => $parentIds['3-SON JURNAL'],
                'created_at' => now(),
            ...
            [
                'name' => 'MUXAMMEDOVA NILUFAR',
                'description' => 'MUXAMMEDOVA NILUFAR',
                'locale_id' => 1,
                'file_url' => 'convention_files/files/Muxammedova Nilufar.pdf',
                'photo_url' => 'convention_files/photos/Titul_page-001.jpg',
                'type' => '1',
                'parent_id' => $parentIds['3-SON JURNAL'],
                'created_at' => now(),
            ...
            [
                'name' => 'DILNAVOZ MURODOVA',
                'description' => 'DILNAVOZ MURODOVA',
                'locale_id' => 1,
                'file_url' => 'convention_files/files/Dilnavoz Murodova.pdf',
                'photo_url' => 'convention_files/photos/Titul_page-001.jpg',
                'type' => '1',
                'parent_id' => $parentIds['3-SON JURNAL'],
                'created_at' => now(),
            ...
            [
                'name' => 'KADIROVA DURDONA',
                'description' => 'KADIROVA DURDONA',
                'locale_id' => 1,
                'file_url' => 'convention_files/files/Kadirova Durdona.pdf',
                'photo_url' => 'convention_files/photos/Titul_page-001.jpg',
                'type' => '1',
                'parent_id' => $parentIds['3-SON JURNAL'],
                'created_at' => now(),
            ...
            [
                'name' => 'SADULLAYEVA NAZOKAT',
                'description' => 'SADULLAYEVA NAZOKAT',
                'locale_id' => 1,
                'file_url' => 'convention_files/files/Sadullayeva Nazokat.pdf',
                'photo_url' => 'convention_files/photos/Titul_page-001.jpg',
                'type' => '1',
                'parent_id' => $parentIds['3-SON JURNAL'],
                'created_at' => now(),
            ...
            [
                'name' => 'NAZAROVA RAYXON',
                'description' => 'NAZAROVA RAYXON',
                'locale_id' => 1,
                'file_url' => 'convention_files/files/Nazarova Rayxon.pdf',
                'photo_url' => 'convention_files/photos/Titul_page-001.jpg',
                'type' => '1',
                'parent_id' => $parentIds['3-SON JURNAL'],
                'created_at' => now(),
