...
//            ],
            ...
            [
                ...
                'journal_name' => 'Penn State University Press',
                'locale_id' => 2,
                'authors' => 'A. Owen Aldridge, Anna Balakian, Claudio Guillén and Wolfgang Bernard
Fleischmann',
            ...
            [
                ...
                'published_date' => '31-01-21 ',
                'created_at' => now(),
                'updated_at' => now(),
            ],
            [
                'name' => 'Comparative Literature: East & West',
                'journal_name' => 'Australia between White Australia and
Multiculturalism: a World Literature Perspective',
                'locale_id' => 2,
                ...
                'published_date' => '21-10-23 ',
                'created_at' => now(),
                'updated_at' => now(),
            ],
            [
                'name' => 'Comparative Literature: East & West',
                'journal_name' => 'World Literary Histories as Rewritings of World
Historiography',
                'locale_id' => 2,
