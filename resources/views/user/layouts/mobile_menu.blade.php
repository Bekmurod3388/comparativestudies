                ...
                @if (Route::has('register'))
                    <li class="menu-item--_23772cc-530e-4394-93e1-113c2558d06e menu-name--secondary-menu">
                        <a href="{{ route('register') }}"
                           class="font-semibold text-gray-600 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white focus:outline focus:outline-2 focus:rounded-sm focus:outline-red-500">Ro'yxatdan
                            o'tish</a>
                        @endif
                        @endauth
                    </li>
