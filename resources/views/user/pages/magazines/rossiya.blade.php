                        ...
                        <div class="project_objectives-box-start">
                            ...
                            <div class="textbook_right">
                                ...
                                <div class="textbook_file">
                                    <a href="target="_blank" href="{{ \Illuminate\Support\Facades\File::exists(public_path('storage/' . $journal->site_url)) ? asset('storage/' . $journal->site_url) : $journal->site_url }}"">  <button>
                                        Jurnal sahifasi
                                    </button></a>
