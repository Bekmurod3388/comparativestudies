    ...
    <div class="col-xxl">
        <div class="card mb-4">
            <div class="card-header d-flex align-items-center justify-content-between">
                <h5 class="mb-0">Dissertatsiya ma`lumotlarini o`zgartirish</h5>
                <small class="text-muted float-end">Malumotlarni o`zgartirishingiz mumkin.</small>
            </div>
            <div class="card-body demo-vertical-spacing demo-only-element">
                <form method="POST" action="{{ route('dissertations.update', $dissertation->id) }}" enctype="multipart/form-data">
                    @csrf
                    @method('PATCH')
                    <div class="row mb-3">
                ...
                ><i class="bx bx-hourglass"></i
                    ></span>
                                <input
                                    ...
                                    value="{{ Carbon::parse($dissertation->thesis_date)->format('Y-m-d') }}"
                                    aria-describedby="basic-icon-default-fullname2"
                                />
                            </div>
                            @error('thesis_date')
