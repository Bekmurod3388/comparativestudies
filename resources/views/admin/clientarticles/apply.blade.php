                            ...
                            <td>
                                <div class="d-flex justify-content-between">
                                    ...
                                    <form action="{{ route('adminarticles.update', $article->id) }}" method="POST" class="d-inline">
                                        ...
                                        <button type="submit" class="btn btn-primary" onclick="return confirm('Maqolani qabul qilasizmi?')">
                                    ...
                                    <form action="{{ route('adminarticles.update', $article->id) }}" method="POST" class="d-inline">
                                        ...
                                        <button type="submit" class="btn btn-danger" onclick="return confirm('Maqolani rad qilasizmi?')">
