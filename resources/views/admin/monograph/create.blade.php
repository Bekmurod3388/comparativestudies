...
@section('content')
    <div class="card">
        <div class="card-header">Yangi Monografiya qo`shish</div>
        ...
        <div class="card-body">
            ...
            <form action="{{ route('monographs.store') }}" id="storeform" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="form-group mb-3">
                    <label for="title">Yangi Monografiya nomi</label>
