...
@section('content')
    <div class="card">
        ...
        <div class="card-body">
            ...
            <form action="{{ route('monographs.update', $monograph->id) }}" id="storeform" method="POST" enctype="multipart/form-data">
                @csrf
                @method("PATCH")
                <div class="form-group mb-3">
                    <label for="title">Monografiya nomi</label>
                    <input type="text" class="form-control" id="title" name="name" value="{{ $monograph->name }}" required>
                </div>
                <div class="form-group mb-3">
                    <label for="title">Chop etilgan jurnal nomi</label>
                    <input type="text" class="form-control" id="title" name="publisher" value="{{ $monograph->publisher }}" required>
                </div>
                <div class="form-group mb-3">
                    <label for="title">Yozuvchilar</label>
                    <input type="text" class="form-control" id="title" name="authors" value="{{ $monograph->authors }}" required>
                </div>
                <div class="form-group mb-3">
                    <label for="type">Monografiya tili</label>
                    <select class="form-control" id="type" name="locale_id" required onchange="selectType(this)">
                        @forelse($locales as $locale)
                            <option value="{{ $locale->id }}" {{ $locale->id == $monograph->locale_id ? 'selected' : '' }}>
                                {{ $locale->name }}
                            </option>
                        @empty
                ...
                <div class="row mb-3">
                    <label class="col-sm-2 mt-4 col-form-label" for="basic-icon-default-photo">Monografiyaning elektron shakli</label>
                    <div class="col-sm-10">
                            ...
                            <div class="tab-content px-0 mt-0">
                                ...
                                <div class="tab-pane fade" id="horizontal-url">
                                    <div class="input-group">
                                        ...
                                        <span class="input-group-text" id="basic-icon-default-fc">Monografiyaning havolasi</span>
                                        <input
                                            name="file_url"
                                            type="url"
                                            class="form-control"
                ...
                ><i class="bx bx-hourglass"></i
                    ></span>
                            <input
                                ...
                                value="{{ Carbon::parse($monograph->published_date)->format('Y-m-d') }}"
                            />
                        </div>
                ...
                <div class="row mb-3">
                    <label class="col-sm-2 col-form-label" for="basic-icon-default-photo">Monografiya sarlavhasi uchun rasm</label>
                    <div class="col-sm-2">
                        <img
