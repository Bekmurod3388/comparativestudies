...
@section('content')
    <div class="card">
        <div class="card-header">Yangi O`quv qo`llnma qo`shish</div>
        ...
        <div class="card-body">
            ...
            <form action="{{ route('trainingmanuals.store') }}" id="storeform" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="form-group mb-3">
                    <label for="title">Yangi O`quv qo`llnma nomi</label>
                    <input type="text" class="form-control" id="title" name="name" required>
                </div>
                <div class="form-group mb-3">
                    <label for="title">Chop etilgan jurnal nomi</label>
                    <input type="text" class="form-control" id="title" name="publisher" required>
                </div>
                <div class="form-group mb-3">
