  ...
  <div class="col-xxl">
    <div class="card mb-4">
      ...
      <div class="card-body demo-vertical-spacing demo-only-element">
        <form method="POST" action="{{ route('abstracts.store') }}" enctype="multipart/form-data">
          @csrf
            <div class="row mb-3">
                ...
                ><i class="bx bx-globe"></i
                    ></span>
                        <input
                            ...
                            aria-describedby="basic-icon-default-fullname2"
                            value="{{old('specialty_code_and_name')}}"
                        />
                    </div>
