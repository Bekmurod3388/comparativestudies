                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-10">
                        <div class="input-group">
                            ...
                            <input type="file" name=img_url class="form-control" id="inputGroupFile01" value="{{$journal->img_url}}"/>
                        </div>
                        @error('img_url')
                        <div class="alert alert-danger" role="alert">Ushbu maydon bo'sh bo'lishi mumkin emas!</div>
                        @enderror
...
@section('js')
    <script>
        ...
        selectElement.selectedIndex = {{ $journal->category }};
    </script>
@endsection
